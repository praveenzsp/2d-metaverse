...
const ArenaBottombar: React.FC<ArenaBottombarProps> = ({
    ...
    return (
        <div className="absolute bottom-0 left-0 w-full bg-gray-900 text-white flex items-center justify-between px-40 z-50 shadow-lg min-h-md">
            {/* Left section */}
            <div className="flex items-center space-x-4">
                ...
                <div className="w-30 h-full">
                    <video
                        ref={videoRef}
                        className="w-full h-full rounded-md translate scale-x-[-1]"
                        autoPlay
                        playsInline
                    />
                </div>
